...
INSERT INTO `audit_plans` (`audit_id`, `audit_title`, `audit_type`, `audit_scope`, `audit_criteria`, `department_name`, `planned_start_date`, `planned_end_date`, `auto_calculated_duration`, `lead_auditor`, `audit_team`, `Comments`, `audit_plan_status`, `row_created_at`, `row_updated_at`) VALUES
(1, 'Audit title 1', 0, 'sc1', 'criteria1', 'fghfhfghfg dept', '2025-05-01', '2025-05-31', NULL, 1, NULL, NULL, 'APPROVED', '2025-05-09 07:14:57', '2025-05-09 07:14:57');
...
INSERT INTO `scheduled_audits` (`scheduled_id`, `audit_id`, `checklist_id`, `planned_start_date`, `planned_end_date`, `auto_calculated_duration`, `audit_process`, `row_created_at`, `row_updated_at`) VALUES
...
(7, 1, 1, '2025-05-01', '2025-05-31', 30, '0', '2025-05-12 11:23:28', '2025-05-12 11:23:28');
...
INSERT INTO `users` (`id`, `eid`, `password`, `name`, `email`, `lastlog`) VALUES
(1, 'user', 'pass', 'User', 'user@gmail.com', '2025-05-16 04:47:31');
...
--
ALTER TABLE `scheduled_audits`
  MODIFY `scheduled_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
