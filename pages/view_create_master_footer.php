                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="footer_name" id="footer_name" placeholder="Footer name" class="form-control form-input">
                                        </div>
                                        <div>
                                            
                                            <label for="footer_desc">Footer description</label>
                                            <input type="text" name="footer_desc" id="footer_desc" placeholder="Footer description"  class="form-control form-input">
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <p>
    ...
    e.preventDefault();
    const editorElement = document.querySelector('.ck.ck-content.ck-editor__editable.ck-rounded-corners.ck-editor__editable_inline.ck-blurred');

if (editorElement) {
    const content = editorElement.innerHTML;
    console.log(content); // Do what you want with the content
} else {
    console.log("Editor element not found.");
}

    const editorData = editorElement.innerHTML;
    ...
    let footer_desc = document.getElementById('footer_desc').value;

    const payload = {
        footer_text:editorData,
